...
import { selectSignUserType } from '../../../store/user/user.selector';
 ...
 const DisplayPassengersList =({
    ...
    const filterDisplayOptionsForParticularFlight = userType === 'Admin' ?
     [{value:'All'},{value: 'without passport'},{value: 'without Address'},{value: 'without DOB'}]
     :[{value:'All'},{value: 'Checked IN'},{value: 'Not Checked IN'}, {value: 'With-Infants'},{value: 'With-Wheelchair'}];
        
    const filterDisplayOptions = [    
        {value:'All'},{value: 'without passport'},{value: 'without Address'},{value: 'without DOB'},
        {value:'Flight-PQ001'},{value:'Flight-PQ002'},{value:'Flight-PQ003'},{value:'Flight-PQ004'},
        {value:'Flight-PQ005'},];
