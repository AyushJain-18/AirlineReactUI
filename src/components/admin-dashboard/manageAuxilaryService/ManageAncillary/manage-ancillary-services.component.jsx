...
const ManageAncillaryServices = ({startFetchingDataForAncillaryService, allFlightsdatae})=>{
  ...
  return(
    <Fragment>
      <div className ='headingContainer'>
        ...
        {expandAllState? 
          <div aria-hidden style={{cursor:'pointer'}}  onClick={()=> setexpandAllState(false)}> <b>- Collapse All</b></div>
          :<div aria-hidden style={{cursor:'pointer'}} onClick={()=> setexpandAllState(true)}> <b>+ Expand All</b></div> }
      </div>
